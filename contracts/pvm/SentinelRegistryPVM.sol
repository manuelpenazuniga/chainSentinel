...
// ============================================================================
// SentinelRegistryPVM — PolkaVM-compatible variant of SentinelRegistry
// ============================================================================
//
// This file is SOURCE-IDENTICAL to SentinelRegistry.sol.
//
// SentinelRegistry has no OpenZeppelin imports and no inline assembly — it is
// pure Solidity. It compiles with resolc without any modifications. This copy
// exists in contracts/pvm/ to make the dual-VM deployment workflow explicit
// and self-contained: one directory, two contracts, one `resolc` invocation.
//
// Verification checklist (resolc compatibility):
//   [✓] No imports (self-contained)
//   [✓] No inline assembly / YUL blocks
//   [✓] No SELFDESTRUCT
//   [✓] No EXTCODECOPY
//   [✓] No delegate-call patterns
//   [✓] No CREATE / CREATE2
//   [✓] Standard mappings, arrays, structs, strings — all supported in PVM
//   [✓] Custom errors with no parameters — supported
//   [✓] Events with indexed topics — supported
//
// Compilation:
//   resolc contracts/pvm/SentinelRegistryPVM.sol \
//     --abi --bin --output-dir contracts/out/pvm/
//
// The ABI produced by resolc for this contract is bit-for-bit identical to
// the ABI produced by solc for SentinelRegistry.sol (verified by diff).
// ============================================================================

/// @title SentinelRegistryPVM
...
/// @dev Compiled with resolc for PolkaVM deployment. Source identical to
///      SentinelRegistry.sol — see contracts/pvm/SentinelRegistryPVM.sol header
///      for a full resolc compatibility checklist.
contract SentinelRegistryPVM {
    // ─── Data Structures ───────────────────────────────────────────────────────
